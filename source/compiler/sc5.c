...
#include "sc.h"
static char *errmsg[] = {
/*001*/  "expected token: \"" "\x1b[33m" "%s" "\033[39m" "\", but found \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*002*/  "only a single statement (or expression) can follow each \"case\"\n",
/*003*/  "declaration of a local variable must appear in a compound block\n",
/*004*/  "function \"" "\x1b[33m" "%s" "\033[39m" "\" is not implemented\n",
...
/*017*/  "undefined or undeclared symbol \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*018*/  "initialization data exceeds declared size\n",
/*019*/  "not a label: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*020*/  "invalid symbol name \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*021*/  "symbol already defined: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
...
/*028*/  "invalid subscript (not an array or too many subscripts): \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*029*/  "invalid expression, assumed zero\n",
/*030*/  "compound statement not closed at the end of file (started at line %d)\n",
/*031*/  "unknown directive\n",
/*032*/  "array index out of bounds (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*033*/  "array must be indexed (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
...
/*046*/  "unknown array size (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
...
/*056*/  "arrays, local variables and function arguments cannot be public (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*057*/  "unfinished expression before compiler directive\n",
/*058*/  "duplicate argument; same argument is passed twice\n",
/*059*/  "function argument may not have a default value (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*060*/  "multiple \"#else\" directives between \"#if ... #endif\"\n",
/*061*/  "\"#elseif\" directive follows an \"#else\" directive\n",
/*062*/  "number of operands does not fit the operator\n",
/*063*/  "function result tag of operator \"" "\x1b[33m" "%s" "\033[39m" "\" must be \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*064*/  "cannot change predefined operators\n",
/*065*/  "function argument may only have a single tag (argument %d)\n",
/*066*/  "function argument may not be a reference argument or an array (argument \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*067*/  "variable cannot be both a reference and an array (variable \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*068*/  "invalid rational number precision in #pragma\n",
/*069*/  "rational number format already defined\n",
/*070*/  "rational number support was not enabled\n",
/*071*/  "user-defined operator must be declared before use (function \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*072*/  "\"sizeof\" operator is invalid on \"function\" symbols\n",
/*073*/  "function argument must be an array (argument \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
...
/*080*/  "unknown symbol, or not a constant symbol (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*081*/  "cannot take a tag as a default value for an indexed array parameter (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*082*/  "user-defined operators and native functions may not have states\n",
/*083*/  "a function or variable may only belong to a single automaton (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*084*/  "state conflict: one of the states is already assigned to another implementation (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*085*/  "no states are defined for symbol \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*086*/  "unknown automaton \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*087*/  "unknown state \"" "\x1b[33m" "%s" "\033[39m" "\" for automaton \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*088*/  "public variables and local variables may not have states (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*089*/  "state variables may not be initialized (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*090*/  "public functions may not return arrays (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*091*/  "ambiguous constant; tag override is required (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*092*/  "functions may not return arrays of unknown size (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n"
};

static char *fatalmsg[] = {
/*100*/  "cannot read from file: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*101*/  "cannot write to file: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*102*/  "table overflow: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
...
/*104*/  "invalid assembler instruction \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
...
/*109*/  "invalid path: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*110*/  "assertion failed: %s\n",
/*111*/  "user error: %s\n"
};

static char *warnmsg[] = {
/*200*/  "symbol \"" "\x1b[33m" "%s" "\033[39m" "\" is truncated to %d characters\n",
/*201*/  "redefinition of constant/macro (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*202*/  "number of arguments does not match definition\n",
/*203*/  "symbol is never used: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*204*/  "symbol is assigned a value that is never used: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*205*/  "redundant code: constant expression is zero\n",
/*206*/  "redundant test: constant expression is non-zero\n",
/*207*/  "unknown #pragma\n"
         "   available #pragma: amxlimit amxram dynamic pack compress align\n"
         "                      codepage ctrlchar tabsize semicolon rational library option\n"
         "                      warning enable warning disable warning push warning pop\n"
         "                      unused deprecated naked once\n",
/*208*/  "function with tag result used before definition, forcing reparse\n",
/*209*/  "function \"" "\x1b[33m" "%s" "\033[39m" "\" should return a value\n",
/*210*/  "possible use of symbol before initialization: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*211*/  "possibly unintended assignment\n",
/*212*/  "possibly unintended bitwise operation\n",
/*213*/  "tag mismatch: expected %s %s but found %s\n",
/*214*/  "possibly a \"const\" array argument was intended: \"" "\x1b[33m" "%s" "\033[39m" "\"\n",
/*215*/  "expression has no effect\n",
/*216*/  "nested comment\n",
/*217*/  "loose indentation (tab/whitespace)\n",
/*218*/  "old style prototypes used with optional semicolumns\n",
/*219*/  "local variable \"" "\x1b[33m" "%s" "\033[39m" "\" shadows a variable at a preceding level\n",
/*220*/  "expression with tag override must appear between parentheses\n",
/*221*/  "label name \"" "\x1b[33m" "%s" "\033[39m" "\" shadows tag name\n",
/*222*/  "number of digits exceeds rational number precision\n",
/*223*/  "redundant \"sizeof\": argument size is always 1 (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*224*/  "indeterminate array size in \"sizeof\" expression (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*225*/  "unreachable code\n",
/*226*/  "a variable is assigned to itself (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*227*/  "more initiallers than enum fields\n",
/*228*/  "length of initialler exceeds size of the enum field\n",
/*229*/  "index tag mismatch (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
/*230*/  "no implementation for state \"" "\x1b[33m" "%s" "\033[39m" "\" in function \"" "\x1b[33m" "%s" "\033[39m" "\", no fall-back\n",
/*231*/  "state specification on forward declaration is ignored\n",
/*232*/  "output file is written, but with compact encoding disabled\n",
/*233*/  "state variable \"" "\x1b[33m" "%s" "\033[39m" "\" shadows a global variable\n",
/*234*/  "function is deprecated (symbol \"" "\x1b[33m" "%s" "\033[39m" "\") %s\n",
/*235*/  "public function lacks forward declaration (symbol \"" "\x1b[33m" "%s" "\033[39m" "\")\n",
...
/*001*/  "; did you mean \"" "\x1b[33m" "%s" "\033[39m" "\"?\n"
};
...
SC_FUNC int errorsuggest(int number,const char *name,const char *name2,int type,int subtype)
{
